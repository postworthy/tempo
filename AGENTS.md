...
2. For non-trivial work, create a proposal in `PROPOSALS/`.
3. Implement only approved scope.
4. Run verification (`pnpm verify`).
5. Update docs (`STATUS.md`, `DECISIONS.md`, roadmap/proposal as needed).
6. Commit atomically with a conventional message.
